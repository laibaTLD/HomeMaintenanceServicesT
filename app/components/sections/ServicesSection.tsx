        ...
        <div className="space-y-0 md:space-y-1 lg:space-y-2">
          {displayServices.map((service: any, index: number) => {
            ...
            return (
              ...
              >
                <div className="flex items-stretch gap-4 md:gap-6 lg:gap-8 xl:gap-12 p-4 md:p-6 lg:p-8 xl:p-10">
                  {/* Number */}
                  <div 
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {/* Learn More Link - Always visible on mobile, visible on hover on desktop */}
                    ...
                    {/* Desktop Learn More Link - Only visible when active */}
                    <div 
