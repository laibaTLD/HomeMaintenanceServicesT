...
import type { ThemeColors, ThemeFonts } from '@/app/hooks/useTheme';
...
function ContentBlockView({
  ...
  block: ContentBlock;
  fonts: ThemeFonts;
  colors: Pick<ThemeColors, 'mainText' | 'secondaryText'>;
}) {
...
function ServiceCard({
  ...
  index: number;
  borderColor: string;
  colors: Pick<ThemeColors, 'mainText' | 'secondaryText' | 'pageBackground'>;
  fonts: ThemeFonts;
}) {
...
export const OurServices: React.FC<OurServicesProps> = ({
  ...
  return (
    ...
    >
      <div className="mx-auto w-full max-w-[90rem] px-6 py-10 sm:py-12 md:px-12 lg:px-16 lg:py-14 xl:px-20">
        <div
          className={cn(
