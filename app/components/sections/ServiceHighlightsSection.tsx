...
export const ServiceHighlightsSection: React.FC<ServiceHighlightsSectionProps> = ({
  ...
  return (
    <section
      className={cn('py-8 lg:py-10 relative overflow-hidden', className)}
      style={{
      ...
      <div ref={sectionRef} className="container mx-auto px-4 relative z-10">
        <div className="grid lg:grid-cols-12 gap-10 items-start">
          ...
          <div className="lg:col-span-7">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-8 sm:gap-x-12 lg:gap-x-16 xl:gap-x-20 gap-y-8 sm:gap-y-12">
